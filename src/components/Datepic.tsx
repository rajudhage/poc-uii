...
function getWeekDays(weekStart: moment.MomentInput) {
...
function getWeekRange(date: moment.MomentInput) {
  return {
    from: moment(date)
      .startOf('week')
      .toDate(),
...
export default class Example extends React.Component {
  ...
  handleDayChange = (date: any) => {
    this.setState({
      selectedDays: getWeekDays(getWeekRange(date).from),
    });
  };

  handleDayEnter = (date: any) => {
    this.setState({
  ...
  handleWeekClick = (weekNumber: any, days: any, e: any) => {
    this.setState({
      selectedDays: days,
    });
  };
